...
\textsc{\Large St. Cross College}\\ % College
{\scshape\LARGE \univname\par}\vspace{1.5cm} % University name

\large \textit{A thesis submitted in fulfillment of the requirements\\ for the degree of \degreename \\ Michaelmas Term 2024}\\[0.3cm] % University requirement text
% \textit{in the}\\[0.4cm]
% \groupname\\
