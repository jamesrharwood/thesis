...
After reading Haynes and Loblay I felt justified letting go of my barrier and enabler plan. My next challenge was one of vocabulary. If I was no longer identifying barriers and enablers, what noun could I use in their place? Haynes and Loblay didn’t present me with any solutions here. Although they argue against using a Barriers and Enablers approach, they use the terms exclusively. I tried “factors that influence reporting guideline adherence”, but an editor complained that the word "factors" had a precise, protected, and quantitative definition in epidemiology as "Events, characteristics, or other definable entities that have the potential to bring about a change in a health condition or other defined outcome" @EpidemiologicFactorsMeSH. I did not intend to limit my inquiry to events, characteristics, nor any other kind of definable entity. I expected this review to deepen my understanding of authors' experience of reporting guidelines and the surrounding system, and to reveal parts of that experience that may influence adherence. Ultimately I settled on the word "influence" instead of factors, barriers, or enablers. The Oxford dictionary defines an influence as something that has "capacity to have an effect on the character, development, or behaviour of someone or something". Just like the term "facilitators and enablers", It's completely untheorized, but unapologetically so. It's definition is sufficiently vague to accommodate context, nuance, and uncertainty.
...
As mentioned in the introduction of this chapter, I identified that barriers and enablers were not consistent experiences. What may be a barrier for one person might be a enabler to others or when occurring in different context, and so I refrained from labelling my analytic themes as one or the other and described them as _influences_ instead. 
