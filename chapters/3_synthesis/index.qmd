---
title: "What influences might researchers encounter when using reporting guidelines? Part 1: A thematic synthesis"
format: 
    html:
...
As mentioned in the introduction of this chapter, I identified that barriers and facilitators were not consistent experiences. What may be a barrier for one person might be a enabler to others or when occurring in different context, and so I refrained from labelling my analytic themes as one or the other and described them as _influences_ instead. 
