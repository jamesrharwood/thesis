...
---
I explain how I created these figures in chapter {{< var chapters.defining-content >}}. I have included them in this chapter to give context to the components in the table above.
...
<!-- Journey after -->
![The layout of the new web-intervention. Users now only need to navigate 2 pages to access reporting guidance. The width of the links represent estimated proportions, based on a realistic aim to reduce the exit rate from the home page and database page by 50%.](figures/sankey-after.png){#fig-sankey-after width=100%}
