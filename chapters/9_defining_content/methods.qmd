...
I invited the EQUATOR staff who participated in the workshops (chapter {{< var chapters.workshops >}}) to form a design advisory group. The group and I met three times between November 2022 and January 2023. In our first meeting, we decided how the home page and redesigned guideline should join and whether any interim steps were required.

In our second meeting, the design group and I sketched ideas for how the home page and reporting guideline page could be laid out and for the positioning of intervention components. These sketches were wireframes: simple illustrations focussing on space allocation, functionalities, and intended behaviours. Wireframes do not include styling. There are no colours, images are represented as blank boxes, and squiggles represent blocks of text. 
