...
I started with a list of {{< var counts.sub_ideas >}} ideas. These were the {{< var counts.sub_ideas_pre_jh >}} ungrouped ideas originating from my focus groups (chapter {{< var chapters.focus-groups >}}), plus {{< var counts.jh_ideas >}} ideas I had whilst I was writing my focus group chapter (see Appendix {{< var appendix.ideas >}}).

I labelled each idea with:

1.  The influence(s) it addresses (derived from chapters {{< var chapters.synthesis >}}, {{< var chapters.review >}}, {{< var chapters.web-audit >}}, and {{< var chapters.workshops >}}).
...
<!-- #ASK sufficient description of co-design? AFAIK there are no definitions, so it's up to the author to describe what they did.  -->
