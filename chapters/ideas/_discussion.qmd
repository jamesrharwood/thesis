...
We also made no attempt to rate ideas. In chapter #TODO I describe how I worked with EQUATOR to prioritise ideas using the APEASE criteria, which is recommended by the BCW and stands for Affordability, Practicability, Efficacy, Acceptability, Side Effects, and Equity. This prioritization should be done be each stakeholder individually as it is subjective (what is practical for one may be impractical for another).
