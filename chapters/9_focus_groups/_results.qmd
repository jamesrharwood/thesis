...
I grouped these ideas into {{< var counts.ideas >}} broader ideas, which I categorised according to whether they could be considered {{< var descriptions.stages >}}. Here I describe these broader ideas. I use the term "stakeholders" instead of "participants" to clarify that ideas came from the focus group participants _and_ the workshop participants. 

I do not describe which stakeholder ideas came from for three reasons. Firstly, stakeholders were all editing the same file, so some ideas would be revisited multiple times by different stakeholders who would build upon the thoughts of previous contributors, editing and extending ideas. Consequently, it wasn't always possible to definitively say _who_ any particular idea came from, as it may have been the product of multiple stakeholders. Secondly, just because an idea _originated_ from a workshop with EQUATOR doesn't mean that other stakeholders didn't _also_ have that idea. An idea may have gone unedited because it was considered already "perfect". Hence labelling ideas as coming from EQUATOR may actually be misleading. Thirdly, I didn't consider labelling the  _origin_ of an idea to be useful because I didn't see it as an indication of that idea's _quality_. In chapter {{< var chapters.workshops >}} I describe how I judged options according to their acceptability, practicability, effectiveness, affordability, side-effects, and equity, and how these criteria are subjective and will differ between stakeholders. I had sought input from stakeholders because I expected that doing so would lead to _more_ ideas, and ideas that were more likely to gain traction. But I didn't expect _all_ of their ideas to be "good". To the contrary, I had explicitly encouraged participants not to worry about whether or not an ideas was "good". 
#TODO: edit the paragraph above.
...
#DECIDE: Note to self. I think I will delete these "Intervention Function" labels, as I will have a table where I define intervention components by their behaviour change technique and intervention function.
