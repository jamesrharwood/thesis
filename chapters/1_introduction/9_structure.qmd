...
I have structured my thesis in three parts. Part 1 (chapters {{< var chapters.synthesis >}} - {{< var chapters.web-audit >}}) addresses my first objective, part 2 (chapters {{< var chapters.bcw >}} - {{< var chapters.defining-content >}}) addresses my second and third, and part 3 (chapter {{< var chapters.pilot >}}) addresses my fourth objective. I'll now give a short summary of each chapter. 
...
![Graphical abstract describing the outputs of research chapters and the relationships between them](chapters/1_introduction/thesis_summary.png){#fig-thesis-graphic}
