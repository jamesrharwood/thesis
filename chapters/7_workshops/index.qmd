...
Although I did not ask EQUATOR members to consider all behaviour change techniques in turn, I did ask them to consider each of our favoured intervention components and to brainstorm solutions to barriers. I then deduced which behaviour change techniques these ideas used and cross checked them against my list of favoured behaviour change techniques, adding any I had missed. The final list is shown in @tab-bcts.

{{< include /table_bcts.md >}}
