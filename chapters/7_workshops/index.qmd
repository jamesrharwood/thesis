...
Ultimately we ended up with a longlist of 18 possible target behaviours. The next step was to select a behaviour from our longlist by considering:
...
We specified authors should apply guidance "as intended by the guideline developer" because thematic synthesis revealed authors may misinterpret guidelines and believe they are adhering when they are not.
...
Although I did not ask EQUATOR members to consider all behaviour change techniques in turn, I did ask them to consider each of our favoured intervention functions and to brainstorm solutions to barriers. I then deduced the behaviour change techniques these ideas used and cross checked them against my list of favoured behaviour change techniques, adding any I had missed. The final list is shown in @tbl-bcts.
