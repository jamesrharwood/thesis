...
The output of the workshops was:

* a target behaviour and sub-behaviours
* a prioritized list of intervention functions and policy categories that we wanted to pursue (because they met APEASE?)
* a decision on how to deliver the new intervention (website)

The output of the focus groups was a list of ideas. 

* mix of stakeholders
* conflated function and category
* not all relevant to us
* not defined as BCT components. 

By intervention component, I mean:

1. a designed element that uses one or more behaviour change technique,
2. which is theorized to work through one or more intervention functions 3. to target one or more behavioural drivers. 

An intervention _change_ is the addition or removal of an intervention component. 
...
What remained was to analyse the ideas, separate out functions from policies/delivery options and select those I wanted to act on and turn them into behavioural components. 

I then had to design and build these components into a prototype that could be piloted amongst authors. 

#ASK: separate out into 2 chapters? Maybe not as it's nice to have table linking to figures. 

I then describe how I turned ideas into intervention components and developed these components into an intervention prototype. 
