...
](chapters/10_redesign/figures/www.equator-network.org_.png){#fig-home-b4 height=200mm}
...
](chapters/10_redesign/figures/db_page_b4.png){#fig-db-b4 height=200mm}
...
](chapters/10_redesign/figures/rg-intro-b4.png){#fig-rg-intro-b4 height=200mm}
...
](chapters/10_redesign/figures/item-b4.png){#fig-item-b4 height=150mm}
...
](chapters/10_redesign/figures/checklist-b4.jpeg){#fig-checklist-b4 height=200mm}
...
](chapters/10_redesign/figures/journal-instructions.png){#fig-journal-instructions height=200mm}
...
](chapters/10_redesign/figures/home.png){#fig-home height=200mm}
...
](chapters/10_redesign/figures/rg-after.png){#fig-rg-intro height=200mm}
...
6) Each item has its own discussion page (linked to from the top right of area A)
 ](chapters/10_redesign/figures/item-after.png){#fig-item height=200mm}

<!-- ## FIG-DISCUSSION -->
![Intervention discussion page. Every reporting item now has its own discussion page where authors can ask and answer questions, and provide feedback to guideline developers. ](chapters/10_redesign/figures/discussion-page.png){#fig-discussion height=150mm}