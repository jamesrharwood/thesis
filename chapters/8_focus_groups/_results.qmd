...
Before the focus groups, my workshops with EQUATOR had generated a list of {{< var counts.EQUATOR_ideas >}} ideas, which formed the initial "ideas table" presented to the first focus group. Focus group participants then extended this list to include {{< var counts.sub_ideas_pre_jh >}} ideas to address {{< var counts.barriers >}} influences. The seventh focus group added just two ideas and extra context to an another two, and so I decided to stop data collection. I grouped ideas into {{< var counts.ideas >}} broader ideas, which I categorised according to whether they could be considered {{< var descriptions.stages >}}. Participants identified {{< var counts.stakeholders >}} stakeholders that could enact these ideas: {{< var descriptions.stakeholders >}}. The broad ideas are summarised in @tbl-focus-groups-results and reported fully in Appendix {{< var appendix.ideas >}}, where they are labelled with the sub-ideas they contain, the influence(s) they address (from Appendix {{< var appendix.barriers >}}) and stakeholders involved.
