...
In chapters {{< var.chapters.workshops >}} I described how I used a framework for designing behaviour change interventions called the Behaviour Change Wheel to prioritise intervention options. Over a series of workshops, EQUATOR UK staff decided to prioritise interventions using education, training, persuasion, modelling (demonstrating using reporting guidelines), and restructuring the environment (both physical and digital environments). Conversely, staff saw restriction and incentivization as inequitable. When considering policy categories, staff prioritized communication, guidelines, and service provision. 
...
My main thesis output is a redesigned reporting guideline and EQUATOR Network home page. 
...
This will have big impact on guideline development groups 
- most have small funding that barely covers delphi process, let alone user testing or dissemination. 
- Some guideline budgets for context 
- Even those with budgets may lack technical skills to create their own websites. 
Thus transformative to all current and future guideline development groups.

Home page is also important. 
...
A simple change with potentially big, measurable effect.
...
I decided not to make an logic model:
 ...
 - logic models have been criticised because capturing complexity and variation in context is difficult.  
...
Similarly, future studies for particular contexts/implementations/channels could formulate a logic model.
...
I have already described the platform and home page, but my work contributes in other ways too. 
...
- In addition to ideas generated in workshops & focus groups (new services/resources to increase RG use), also opens up a new paradigm/way of approaching RG research. 
- Previously a lot of audits, a few intervention studies, few qualitative. 
- I've opened up a new way of thinking. Demonstrated how qualitative methods can be used, how much research is required for development, and how RGs actually touch on implementation science, behaviour change, and (further unexplored territories) education pedagogy. 
- These avenues lead to new collaborators and new funders. New opportunities.
Where EQUATOR has previously had to shoehorn meta-research into grants focussing on research closer to clinical practice, hopefully going forward RGs can be front and center. 
...
- Not exact copy, although some findings might be pertinent (e.g. prioritising personal, immediate rewards over hypothetical ones to others)
...
- Summary of future research recommendations for previous chapters 
    - End on future of website. Extending it with checklists. 
- Designing tools:
    - Checklist design deserves to be studied. 
    - As does resources for drafting. Are templates enough? What else? 
    - Similarly resources for designing. Link back to Introduction about what RGs were made.
    - Assessment tools?
- Implementing ideas not addressed by the website:
...
- Making RGs easier will make it easier for journals to adopt RG policies. 
