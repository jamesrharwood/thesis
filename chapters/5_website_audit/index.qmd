...
When trying to book her COVID vaccine booster, a relative gave up because they could not understand the website booking process. When interventions rely on a website their success relies, in part, on whether people can easily understand and use it. The same is true for reporting guidelines which are disseminated through a number of webpages like journal author guidelines, guideline-specific websites, and the focus of this chapter; the EQUATOR Network's website. 
