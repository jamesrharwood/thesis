...
- Adding images to make the home page more attractive and to convey meaning of accompany text (see @fig-before-after-home).
- Adding publisher logos to foster trust
- Reorganising the introduction to SRQR to make it appear shorter (see @fig-before-after-rg).

::: {#fig-before-after-home layout-ncol=2}

![Before](figures/home-v1.png){#fig-home-v1}
...
::: {#fig-before-after-rg layout-ncol=2}

![Before](figures/rg-v1.png){#fig-home-v1}

![After initial revision](figures/rg-v2.png){#fig-home-v2}
...
All participants realised that the website was aimed at researchers. This is perhaps not surprising as our study advert said we wanted to speak with qualitative researchers "about a new website. Even though we did not specify who the intended audience was, perhaps it was heavily implied. Indeed, some participants had assumed the website was aimed at _qualitative_ researchers (we had specific qualitative because of our test guideline), suggesting their perception of target audience had been influenced by our recruitment materials. However, these same participants voiced that the website felt "more open" {{< var pilot.participants.PPT-OMK >}}, like it was aimed at medical researchers more generally (which it is). Hence although our recruitment materials may have primed participants to expect the website to be aimed at qualitative researchers, that they correctly identified it to be for medical researchers in general suggests our intervention components were working as intended. This was further evidenced by participants who described the intended audience as "those who are just getting started in the career" {{< var pilot.participants.PPT-OMK >}} or "master research or higher degrees and also for some junior scholars" {{< var pilot.participants.PPT-YD >}}". 
...
A few components required clarifying the relationships between the website, the EQUATOR Network, the guideline developers, and the original publications. For example, a couple of participants were not immediately sure whether the guidance on the website was the same as the guidance within the publication. Some asked whether the citation and journal data (which was supposed to instil trust) were pertaining to the publication or the website, and which one they themselves should cite. When I asked participants where they might look for clarification, all referred to the FAQ and felt reassured after reading how the guidance was developed, but suggested this explanation be summarised and signposted earlier. Similarly, a couple of participants suggested that EQUATOR should be introduced briefly earlier on the home page.
...
Participants' echoed other barriers I'd identified in my thematic synthesis when reflecting on their prior writing experiences, including:
...
- Describing a guideline as "version 1.0" might make people feel like the guidance is (too) new, and therefore less trustable. This barrier was new to my website as no existing reporting guidelines describe themselves as "1.0". 
