...
"Ensure guidance is open access"
* Authors without subscriptions can access 
* ALlows others to build upon guidance - extend or tools

#### {{< var IFs.citations >}}

"Ask researchers to cite the guidelines they use"
"Encourage researchers to cite guidelines in their manuscripts"
"Highlighting RG items in the manuscript so that it becomes more visible that an RG has been used and that it has helped the creation of a report"
* makes RGs discoverable from a single article, but also...
"Provide “social proof” e.g., number of downloads, citations, or visitsReference"
...
"Provide case studies / testimonials from research consumers for whom an item is important
"Testimonials from “nervous” researchers"
"Testimonials from editors to put researchers at ease"
"Provide testimonials illustrating how detrimental poor reporting is for end users (e.g. patients unable to understand a research article that could have helped them had it been better reported)"
"Provide quotes from editors or reviewers emphasising their preference for transparent reporting"
"Provide quotes from authors/researchers who felt that RGs helped their work and who’ve had positive experiences (e.g., helped with co-authorship communications, made writing easier, etc.)"
"Testimonials from researchers describing their experiences of using guidelines, what they would do differently etc"
"Provide case studies"
"Provide case studies that showcase researchers with a range of experiences, including experienced researchers who have benefited by changing their practices"
"Provide good examples of other researchers that have found RGs useful"
...
"Researchers need budget to allocate time to writing. Funders could encourage proper financial/time budgeting for writing."
...
"Create new rewards for researchers e.g., badges on published articles or a certificate after completing training"
"Offer some sort of tangible reward/benefit after completing a reporting guideline (e.g., publishers offering a fast-track review/discount, transparency badge from something like publons)"
"Badges"
...
"Create spaces for researchers to connect with other researchers to celebrate and share experiences e.g., forums, meetings, tea clubs, clinics both in real life and virtual"
