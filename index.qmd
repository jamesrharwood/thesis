...
# Refining reporting guidelines: identifying and addressing barriers using behaviour change theory {.unnumbered}

#ASK Alterantively: Refining the dissemination of reporting guidance using behaviour change theory
...
* Title page 
* Appendices should come after references
* Table and figure formatting
* Add "Reflections on this chapter" paragraphs to end of research chapters
* Need to write: Abstract, Interviews chapter, Discussion
